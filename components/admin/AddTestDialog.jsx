  ...
  return (
    ...
    <div className="bg-white rounded-lg shadow-lg md:w-[70vw] w-[90vw] mx-auto">
      ...
      <form onSubmit={handleFormSubmit} className="space-y-4 p-4">
        ...
        <div>
          <label className="block text-[14px] text-neutral02">Test Description:</label>
          <input
      ...
      {pdfPreview && (
        ...
        <div className="flex flex-col sm:flex-row sm:gap-8">
          <div className="w-full sm:w-1/2">
            <label className="block text-[14px] text-neutral02">Duration:</label>
            <input
              type="text"
              name="duration"
          ...
          <div className="w-full sm:w-1/2">
            <label className="block text-[14px] text-neutral02">Total Marks:</label>
            <input
              type="number"
