...
const Page = () => {
  ...
  {tests.length > 0 ? (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
      {tests.map((test) => {
        ...
        return (
          <div
            key={test.id}
            className="bg-white rounded-lg border border-[#E5E0E0] w-full max-w-[360px] p-6 flex flex-col justify-between h-full"
          >
            <div>
              <h2 className="text-2xl font-medium mb-2">{test.testTitle}</h2>
    ...
    <p className="text-center text-gray-600">No tests found in this package.</p>
  )}
</div>
